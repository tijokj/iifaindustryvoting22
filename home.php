...
<html lang="en">
	...
	<body onload="_verifyLogin()" class='thetop'>
		...
		<script src="js/Popular/dtBestStory-Adapted.js?v=<?php echo $datetime;?>"></script>
